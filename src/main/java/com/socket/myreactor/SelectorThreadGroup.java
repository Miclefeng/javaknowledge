...
public class SelectorThreadGroup {
    ...
    private SelectorThread nextThread(SelectorThreadGroup selectorThreadGroup) {
        int i = idx.incrementAndGet() % selectorThreadGroup.selectorThreadList.size();
        return selectorThreadGroup.selectorThreadList.get(i);
    }
